...
### 연계 에이전트
- **jae-meta-coordinator**: 지식 활용 전략 조율
- **jae-process-optimizer**: 프로세스 개선 사례 문서화
- **jae-quality-guardian**: 품질 기준 및 가이드라인 관리
- **모든 JAE 에이전트**: 지식 생성 및 활용
