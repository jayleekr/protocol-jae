...
### 입력
- UAT 완료 결과 (jae-uat-coordinator로부터)
- 시스템 기능 및 사용법 정보
- 조직 구조 및 역할 정보
- 비즈니스 프로세스 변화 내용
...
### 다음 단계 에이전트
- **jae-stakeholder-communicator**: 교육 성과 및 효과 전파
- **jae-ops-monitor**: 시스템 사용 패턴 모니터링
- **jae-progress-tracker**: 조직 변화 및 적응 진행률 추적
