...
### 입력
- 배포 완료 신호 (jae-deployment-manager로부터)
- 애플리케이션 및 인프라 메트릭
- 로그 데이터
- 외부 서비스 상태
...
### 다음 단계 에이전트
- **jae-stakeholder-communicator**: 사고 상황 전파
- **jae-risk-manager**: 운영 위험 요소 분석
- **jae-deployment-manager**: 긴급 패치 또는 롤백
