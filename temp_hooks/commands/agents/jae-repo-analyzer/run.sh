...
# 에이전트 정보
readonly AGENT_NAME="jae-repo-analyzer"
...
JAE Repository Analyzer - GitHub 저장소 분석 전문가
...
ENVIRONMENT VARIABLES:
    ...
    JAE_OUTPUT_DIR         Base output directory
...
main() {
    ...
    if [[ -z "$OUTPUT_DIR" ]]; then
        ...
        OUTPUT_DIR="$JAE_OUTPUT_DIR/${AGENT_NAME}_${timestamp}"
    fi
