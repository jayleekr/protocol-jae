...
### 연계 에이전트
- **jae-meta-coordinator**: 개선 계획 조율
- **jae-quality-guardian**: 품질 기준 협의
- **jae-knowledge-curator**: 개선 사례 문서화
- **모든 JAE 에이전트**: 프로세스 데이터 수집

## 설정 요구사항

```yaml
agent_config:
  name: jae-process-optimizer
