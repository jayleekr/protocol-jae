...
### 다음 단계 에이전트
- **jae-quality-guardian**: 보안 품질 기준 적용
- **jae-deployment-manager**: 보안 검증 후 배포 진행
- **jae-ops-monitor**: 런타임 보안 모니터링
- **jae-stakeholder-communicator**: 보안 상태 커뮤니케이션

## 설정 요구사항

```yaml
agent_config:
  name: jae-security-scanner
